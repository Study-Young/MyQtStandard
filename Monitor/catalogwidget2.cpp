...
#include "ui_catalogwidget2.h"

CatalogWidget2::CatalogWidget2(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::CatalogWidget2)
{
    ui->setupUi(this);
...
CatalogWidget2::~CatalogWidget2()
{
    delete ui;
}

void CatalogWidget2::initForm()
{
...
void CatalogWidget2::buttonClick1()
{
...
void CatalogWidget2::buttonClick2()
{
    NavButton *b = (NavButton *)sender();
    qDebug() << "当前按下" << b->text();
    for (int i = 0; i < btns2.count(); i++) {
...
void CatalogWidget2::buttonClick3()
{
    NavButton *b = (NavButton *)sender();
    qDebug() << "当前按下" << b->text();
    for (int i = 0; i < btns3.count(); i++) {
...
void CatalogWidget2::buttonClick4()
{
    NavButton *b = (NavButton *)sender();
    qDebug() << "当前按下" << b->text();
    for (int i = 0; i < btns4.count(); i++) {
...
void CatalogWidget2::buttonClick5()
{
    NavButton *b = (NavButton *)sender();
    qDebug() << "当前按下" << b->text();
    for (int i = 0; i < btns5.count(); i++) {
...
void CatalogWidget2::buttonClick6()
{
    NavButton *b = (NavButton *)sender();
    qDebug() << "当前按下" << b->text();
    for (int i = 0; i < btns6.count(); i++) {
...
void CatalogWidget2::buttonClick7()
{
    NavButton *b = (NavButton *)sender();
    qDebug() << "当前按下" << b->text();
    for (int i = 0; i < btns7.count(); i++) {
