#include "mycheckbox2.h"
#include <QtMath>

MyCheckBox2::MyCheckBox2(QWidget *parent) : MyCheckBox(parent)
{

}

void MyCheckBox2::setUncheckedColor(QColor c)
{
    this->uncheckedColor = c;
    update();
}

void MyCheckBox2::enterEvent(QEvent *e)
{
    QCheckBox::enterEvent(e);
    startAnimation("hover_prog", getHoverProg(), 1, 300, QEasingCurve::OutBack);
}

void MyCheckBox2::leaveEvent(QEvent *e)
{
    QCheckBox::leaveEvent(e);
    startAnimation("hover_prog", getHoverProg(), 0, 300, QEasingCurve::OutBack);
}

void MyCheckBox2::checkStateChanged(int state)
{
...
void MyCheckBox2::drawBox(QPainter &painter, QRectF rect)
{
